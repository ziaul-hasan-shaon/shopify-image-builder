import { Box, Grid, GridItem, Image, Text, Slider, SliderTrack, SliderFilledTrack, SliderThumb, Button, Popover, PopoverTrigger, PopoverContent, PopoverArrow, PopoverBody, useDisclosure, Heading, Divider, AbsoluteCenter, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Textarea, Spinner, HStack, Tooltip } from '@chakra-ui/react';
  ...
  useEffect(() => {
    const updateWidth = () => {
      if (containerRef.current) {
        setFooterWidth(containerRef.current.offsetWidth);
      }
    };
    updateWidth();
